...
axiosRetry(api, { 
    ...
    retryCondition: (error) => {
        // Solo permitimos reintentos automáticos en peticiones GET para evitar duplicar POSTs
...
export const authService = {
    ...
    // Al enviar un FormData en React Native, omitimos el header manual 'Content-Type' 
    // para que Axios gestione correctamente el boundary del multipart.
